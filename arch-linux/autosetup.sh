...
PACKAGES=(
    ...
    mpv google-chrome brave-bin etcher-bin postman dbeaver mongodb-compass
    telegram-desktop lazydocker ttf-jetbrains-mono-nerd xclip docker virt-manager virt-viewer gnome-keyring stremio
    dconf-editor
