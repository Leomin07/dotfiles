...
PACKAGES=(
    ...
    python python-pip python-virtualenv tk ffmpeg vim neovim stow eza bat fzf tree ripgrep tldr dotnet-sdk-8.0 dotnet-runtime-8.0 zoxide starship git fastfetch visual-studio-code-bin mission-center dbeaver lazygit lazydocker docker
    ...
    gnome-disk-utility polkit-gnome obs-studio ntfs-3g exfat-utils exfat-fuse imv pamac-gtk3 dconf-editor qemu libvirt virt-manager-git mpv cava keyd

    # --- Audio (commented out, optional) ---
    pavucontrol-qt libdbusmenu-gtk3 playerctl pavucontrol-git alsa-utils
...
# Gnu stow config
stow_configs() {
    local folders=("ghostty" "kitty" "nvim" "cava" "rofi" "keyd" "picom" "qtile" "dunst")
